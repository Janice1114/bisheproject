                    ...
                    if(url[1] != "gsxt.gdgs.gov.cn"){
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                result = data.split(',')
                                result_message = result[4].split(' ')[0]
                                $('.result_id').val(result[0]);
                                $('.result_name').val(result[1]);
                                $('.result_time').val(result[2]);
                                $('.result_address').val(result[3]);
                                $('.result_message').val(result_message);
                             }
                         });
                    }
                    else{
